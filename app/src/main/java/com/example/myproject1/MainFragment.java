...
public class MainFragment extends BrowseSupportFragment implements OnItemViewClickedListener {
    ...
    private void setUI() {
        setTitle("Netflix"); // our In-App title will be shown in top-right corner
    ...
    private void loadRows() {
        ...
        adapterForRow2.add(new SingleRowView("Ironman",getContext().getResources().getDrawable(R.drawable.ironman)));
        adapterForRow2.add(new SingleRowView("The Matrix",getContext().getResources().getDrawable(R.drawable.matrix)));
        adapterForRow2.add(new SingleRowView("Avengers",getContext().getResources().getDrawable(R.drawable.avengers)));
        adapterForRow2.add(new SingleRowView("Ironman",getContext().getResources().getDrawable(R.drawable.ironman)));
        adapterForRow2.add(new SingleRowView("The Matrix",getContext().getResources().getDrawable(R.drawable.matrix)));
        adapterForRow2.add(new SingleRowView("Avengers",getContext().getResources().getDrawable(R.drawable.avengers)));
    ...
    private class MyPresenter extends Presenter{
        ...
        public void onBindViewHolder(ViewHolder viewHolder, Object object) {
            ...
            icv.setMainImageDimensions(513,376);
